...
import { createSanctionsRoutes, createHistoryRoutes, createStatsRoutes, createHealthRoutes, } from './api/routes/index.js';
// Shared
...
export class Application {
    ...
    createDependencies() {
        ...
        const healthService = new HealthService(this.sequelizeConnection);
        // Controllers
