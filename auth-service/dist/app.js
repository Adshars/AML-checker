...
export const createApp = () => {
    ...
    const authenticationService = new AuthenticationService(userRepository, organizationRepository, tokenService, hashingService);
    const organizationService = new OrganizationService(organizationRepository, userRepository, hashingService, emailService, config);
    const userService = new UserService(userRepository, organizationRepository, hashingService, emailService, config);
    const passwordService = new PasswordService(userRepository, passwordResetTokenRepository, hashingService, emailService, config);
    // ==========================================
