...
import type { UserResponseDto } from '../../application/dtos/responses/UserResponseDto.js';
...
export class UserController {
  ...
  registerUser = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
      ...
      const result = await this.userService.registerUser(registerDto) as UserResponseDto;
