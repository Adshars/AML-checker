...
describe('GET /history Integration Test', () => {
    ...
    it('should allow filtering by search query', async () => {
        ...
        const callArgs = mockAuditLogModel.findAndCountAll.mock.calls[0][0] as { where: Record<string, unknown> };
    ...
    it('should filter by hasHit parameter', async () => {
        ...
        const callArgs = mockAuditLogModel.findAndCountAll.mock.calls[0][0] as { where: { hasHit: unknown } };
    ...
    it('should filter by date range (startDate and endDate)', async () => {
        ...
        const callArgs = mockAuditLogModel.findAndCountAll.mock.calls[0][0] as { where: { createdAt: unknown } };
