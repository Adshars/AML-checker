...
export class NodemailerEmailService {
  ...
  async verifyConnection(): Promise<boolean> {
    try {
      ...
      const mailError = error as DuckTypedMailError;
   ...
   */
  async sendWelcomeEmail(email: string, firstName: string, role: string, frontendUrl: string): Promise<void> {
    try {
      await this.verifyConnection();
