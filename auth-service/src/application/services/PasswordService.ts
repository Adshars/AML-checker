...
export class PasswordService {
   ...
   */
  async requestPasswordReset(email: string, requestId?: string): Promise<{ message: string }> {
    ...
    await this.passwordResetTokenRepository.deleteByUserId(user.id as string);
